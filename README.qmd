...
- **SAS Studio layout.** A column-selection panel with char/num type icons
  ...
  a names-versus-labels header toggle, click-a-header to sort, and a free-text
  "Filter Table Rows" expression.
...
right-click for the header menu to add a filter or copy the column. Click the
